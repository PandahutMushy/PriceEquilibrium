...
<body class="fixed-navigation mini-navbar skin-1 pace-done">    
        <div class="body-wrapper mt-4">
            ...
            <h2>A Practical Explanation of the Equilibrium Price</h2>    
                ...
                <li>At the price of <a tabindex="10" href="#" onHover='document.priceform.price[3].click();' onClick='document.priceform.price[3].click();'><b>$30</b></a>, the <b>DQ</b> value of <b>10</b> is <i>below</i> the <b>SQ</b> value of <b>27</b>, which is indicative of a <b>falling</b> price. </li>               
                <li>At the price of <a tabindex="11" href="#" onHover='document.priceform.price[0].click();' onClick='document.priceform.price[0].click();'><b>$15</b></a>, the <b>DQ</b> value of <b>25</b> is <i>above</i> the <b>SQ</b> value of <b>7</b>, which is indicative of an <b>increasing</b> price. </li>               
